function adflyredir_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
adflyredir_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				adflyredir_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
adflyredir_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
adflyredir_xmlhttpRequester.prototype.setupRequestEvent =
